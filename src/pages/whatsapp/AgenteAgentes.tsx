    ...
    <div className="p-6 md:p-10 text-white min-h-screen bg-black">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-12">
          ...
          <button className="bg-yellow-500 hover:bg-yellow-400 text-black px-8 py-4 rounded-2xl font-bold transition-all active:scale-95 shadow-lg shadow-yellow-500/20 flex items-center gap-2 group">
